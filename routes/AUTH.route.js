...
const { SIGNUP_VALIDATION_SCHEMA, SIGNIN_VALIDATION_SCHEMA, FLAG_USER_DELETION_VALIDATION_SCHEMA, PASSWORD_RESET_VALIDATION_SCHEMA, NEW_PASSWORD_RESET_VALIDATION_SCHEMA, VERIFY_USER_ACCOUNT_VALIDATION_SCHEMA, } = require("../config/SchemaValidator.js");
...
const { HANDLE_USER_ACCOUNT_DELETION, HANDLE_USER_ACCOUNT_DELETION_CRON_FUNCTION } = require('../controllers/auth/auth.user.handler.controller.js');
...
const { GET_VERIFICATION_CODE_EMAIL, VERIFY_USER_ACCOUNT } = require("../controllers/auth/auth.verify.controller.js");
