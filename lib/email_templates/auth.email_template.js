        ...
        <body style="font-family: 'Poppins', sans-serif; background-color: #f4f4f4; padding: 20px;">
          ...
          <tr>
            <td style="padding: 20px;">
              ...
              <p style="color: #666;">If this sign-in was not initiated by you, please <a href="https://prokemia.com/password_reset?email=${DATA?.email}" style="color: #4E2FD7;">secure your account</a> and contact us immediately.</p>
